public class Main {
  public static void main(String[] args) {
    ...
    System.out.println(bestEndTime-bestStartTime + " nanosecond difference for the best time");
    ...
    // * Calculate elapsedTime here
    System.out.println(worstEndTime-worstStartTime + " nanosecond difference for the worst time");
